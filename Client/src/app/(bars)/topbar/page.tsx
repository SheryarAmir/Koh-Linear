    ...
    <div className="flex h-[65px] items-center justify-between border-b border-gray-200 bg-white px-4">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative">
          ...
          <Input placeholder="Search..." className="w-64 pl-9 bg-gray-50 border-gray-200 focus:bg-white" />
        </div>
      ...
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="bg-white">
            <DropdownMenuItem onClick={() => onViewChange("display")}>Display</DropdownMenuItem>
